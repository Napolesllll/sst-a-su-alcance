...
const services: Service[] = [
  {
    ...
    description:
      "Implementación de sistemas SST, documentación legal y auditorías para cumplimiento normativo.",
    subservices: [
      {
        ...
        details:
          "Diseñamos e implementamos sistemas de gestión en seguridad y salud en el trabajo adaptados a tu organización. Nuestros expertos garantizan el cumplimiento normativo y la mejora continua de tus procesos.",
      },
      {
        title: "CAPACITACIONES EN SST, COPASST, COCOLAB",
        items: [
          "Elaboración de COPASST",
          "Reglamentos de Higiene y Seguridad",
          "Planes de Emergencia",
        ],
        details:
          "Preparamos toda la documentación requerida por la legislación colombiana, asegurando que tu empresa cumpla con los requisitos legales en materia de seguridad y salud en el trabajo.",
      },
      {
        title: "Auditorías y diagnósticos",
        items: [
          "Diagnóstico Inicial SST",
          "Auditorías Legales",
          "Inspecciones Programadas",
        ],
        details:
          "Realizamos evaluaciones exhaustivas de tus procesos de seguridad, identificando oportunidades de mejora y asegurando el cumplimiento normativo.",
      },
    ],
  },
  {
    ...
    description:
      "Cursos certificados y programas continuos en seguridad laboral con modalidades flexibles.",
    subservices: [
      {
        title: "Trabajo en alturas",
        items: [
          "Curso básico (40 horas)",
          "Curso avanzado (80 horas)",
          "Coordinador de trabajo en alturas",
        ],
        details:
          "Capacitación certificada para trabajos en alturas según Resolución 1409 de 2012. Entrenamiento teórico-práctico con simulaciones reales.",
      },
      {
        ...
        details:
          "Formación especializada para trabajos en espacios confinados, cumpliendo con los estándares de seguridad requeridos.",
      },
      {
        title: "Primeros auxilios",
        items: ["Básicos", "Avanzados", "Reanimación Cardiopulmonar (RCP)"],
        details:
          "Capacitación en atención inicial de emergencias, manejo de heridas, quemaduras, fracturas y soporte vital básico.",
      },
    ],
  },
  {
    ...
    description:
      "Vigilancia epidemiológica, control de riesgos y gestión de incidentes para bienestar laboral.",
    subservices: [
      {
        ...
        details:
          "Programas de vigilancia médica adaptados a los riesgos específicos de cada puesto de trabajo, con seguimiento y control continuo.",
      },
      {
        title: "Programas de salud mental",
        items: ["Estrés Laboral", "Acoso Laboral", "Bienestar Emocional"],
        details:
          "Intervenciones para promover la salud mental en el entorno laboral y prevenir enfermedades derivadas del trabajo.",
      },
      {
        title: "Ergonomía laboral",
        items: [
          "Evaluaciones Puesto de Trabajo",
          "Diseño de Estaciones",
          "Prevención de Lesiones",
        ],
        details:
          "Soluciones ergonómicas para mejorar las condiciones de trabajo y prevenir trastornos musculoesqueléticos.",
      },
    ],
  },
  {
    ...
    description:
      "Prevención de riesgos, equipos de protección y manejo de sustancias peligrosas.",
    subservices: [
      {
        ...
        details:
          "Desarrollo de procedimientos seguros para operaciones críticas, minimizando riesgos en trabajos de alto peligro.",
      },
      {
        title: "Dotación de elementos de protección personal (EPP)",
        items: ["Selección", "Uso Adecuado", "Mantenimiento"],
        details:
          "Asesoría en selección, uso y mantenimiento de equipos de protección personal según los riesgos de cada puesto.",
      },
      {
        ...
        details:
          "Soluciones técnicas para la prevención y control de incendios, incluyendo sistemas fijos y equipos portátiles.",
      },
    ],
  },
  {
    ...
    description:
      "Software SST, aplicaciones móviles y soluciones digitales para seguridad laboral.",
    subservices: [
      {
        title: "Software SST",
        items: [
          "Gestión documental (Soporte ISO 45001)",
          "Reporte de incidentes",
          "Dashboards de indicadores",
        ],
        details:
          "Sistema integral para la gestión de seguridad y salud en el trabajo, con módulos para todos los procesos SST.",
      },
      {
        ...
        details:
          "Aplicación móvil para realizar inspecciones de seguridad, reportar condiciones inseguras y dar seguimiento.",
      },
      {
        ...
        details:
          "Plataforma virtual para la capacitación del personal en temas de seguridad y salud en el trabajo.",
      },
    ],
  },
  {
    ...
    description:
      "Plantillas, guías legales y contenido educativo para gestión preventiva.",
    subservices: [
      {
        ...
        details:
          "Plantillas editables listas para usar en tus procesos de gestión SST.",
      },
      {
        title: "Checklist de inspección",
        items: ["Áreas de Trabajo", "Equipos", "Procedimientos"],
        details:
          "Listas de verificación para realizar inspecciones de seguridad de manera eficiente.",
      },
      {
        title: "Guías legales",
        items: [
        ...
        details:
          "Guías actualizadas sobre normativa colombiana en seguridad y salud en el trabajo.",
      },
    ],
  },
  {
    ...
    description:
      "Gestión de actividades de alto riesgo con protocolos y seguimiento especializado.",
    subservices: [
      {
        title: "Identificación de tareas críticas",
        items: [
          "Evaluación de Riesgos",
          "Matriz de Tareas Críticas",
          "Protocolos Específicos",
        ],
        details:
          "Determinamos y clasificamos las tareas de mayor riesgo, estableciendo procedimientos seguros.",
      },
      {
        ...
        details:
          "Implementamos sistemas de control y monitoreo para garantizar el cumplimiento de los protocolos.",
      },
      {
        ...
        details:
          "Formación específica en procedimientos críticos para minimizar la probabilidad de incidentes.",
      },
    ],
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center mb-16">
        ...
        >
          Soluciones integrales en seguridad y salud en el trabajo para proteger
          a tu equipo y optimizar tus procesos
        </motion.p>
      </div>
      ...
      <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {services.map((service) => (
          ...
          >
            <motion.div
              className={`bg-gradient-to-br from-white to-cyan-50 rounded-2xl p-6 shadow-xl border border-white border-opacity-50 h-full flex flex-col items-center text-center backdrop-blur-sm overflow-hidden ${
                hoveredCard === service.id ? "ring-2 ring-cyan-500/30" : ""
              }`}

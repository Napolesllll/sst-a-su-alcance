        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-12">
            ...
            <div className="space-y-6">
              ...
              <p className="text-cyan-100 leading-relaxed">
                Expertos en Seguridad y Salud en el Trabajo. Ofrecemos
                soluciones integrales para proteger a tus colaboradores y
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-cyan-100 mb-4">
                  Recibe las últimas novedades en seguridad y salud en el
                  trabajo.
                </p>
                <div className="flex">
                  <input
                  ...
                  {[
                    {
                      name: "Facebook",
                      color: "#3b5998",
                      icon: "M22.675 0h-21.35C.593 0 0 .592 0 1.325v21.351C0 23.408.593 24 1.325 24h11.495v-9.294H9.691v-3.622h3.129V8.413c0-3.1 1.894-4.788 4.659-4.788 1.325 0 2.466.099 2.797.143v3.243l-1.918.001c-1.504 0-1.794.716-1.794 1.763v2.313h3.587l-.467 3.622h-3.12V24h6.116C23.406 24 24 23.408 24 22.676V1.325C24 .592 23.406 0 22.675 0z",
                    },
                    {
                      name: "Twitter",
                      color: "#1da1f2",
                      icon: "M23.954 4.569c-.885.389-1.83.654-2.825.775 1.014-.608 1.794-1.574 2.163-2.724-.95.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.164-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.248-2.229-.616v.061c0 2.385 1.693 4.374 3.946 4.827-.734.2-1.51.232-2.224.084.626 1.956 2.444 3.377 4.6 3.417-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.209 7.557 2.209 9.054 0 14-7.496 14-13.986 0-.21 0-.423-.015-.633.962-.695 1.8-1.562 2.46-2.549z",
                    },
                    {
                      name: "LinkedIn",
                      color: "#0077b5",
          ...
          <div className="flex flex-col md:flex-row items-center justify-between py-6 gap-4">
            <p className="text-sm md:text-base select-none">
              &copy; {currentYear} SST A SU ALCANCE. Todos los derechos
              reservados.
            </p>

            <div className="flex space-x-6">
              {["Términos", "Privacidad", "Cookies", "FAQ"].map(
                (item, index) => (
                  <a
                    key={index}
                    href="#"
